...
<body> -->
    <a href="principal.php" class="w3-display-topmiddle w3-red w3-center w3-padding w3-margin-top w3-button w3-round-large w3-card-4" style="text-decoration:none; ">
            <i class="fa fa-ban" style="font-size:3em"></i>
            <p style="font-weight:bold;">CANCELAR EXCLUSÃO</p>
    </a>

    <div class="w3-padding w3-content w3-text-grey w3-third w3-margin w3-display-middle">
    <h1 class="w3-center w3-light-blue w3-round-large w3-margin">Excluir - ID: <?php echo " ".$_GET['id']?> </h1>
        ...
        <form action="excluirAction.php" class="w3-container" method='post'>
            ...
            <button name="btnExcuir" class="w3-button w3-light-blue w3-cell w3-round-large w3-right">

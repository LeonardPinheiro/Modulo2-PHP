 ...
 <title>Atualizar - MYSQLI</title>
    ...
    <body> -->
        <a href="principal.php" class="w3-display-topleft">
            ...
            <h1 class="w3-center w3-light-blue w3-round-large w3-margin">Atualizar - ID: <?php echo " ".$_GET['id']?> </h1>
                ...
                <br>
                <button name="btnAtualizar" class="w3-button w3-light-blue w3-cell w3-roundlarge w3-right w3-round-large w3-card-4">
